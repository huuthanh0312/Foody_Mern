		...
		<div>
			<footer className="footer xl:px-24 py-10 px-4 text-base-content">
				<aside>
					...
					<p className="my-5 md:w-48">Savor the artistry where every dish is a culinary masterpiece</p>
				</aside>
				<nav>
				...
				<nav>
					...
					<a className="link link-hover">thanhfoody@email.com</a>
					<a className="link link-hover">+84 958 248 966</a>
